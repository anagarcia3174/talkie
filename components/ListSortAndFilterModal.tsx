...
export default function ListSortAndFilterModal({
  ...
  return (
    <Modal visible={isVisible} transparent animationType="fade" onRequestClose={onClose}>
      ...
      />
      <View className="absolute bottom-0 left-0 right-0 gap-y-2 rounded-t-2xl bg-primary-100 px-4 pb-8 pt-2 dark:bg-primary-900">
                ...
                {SORT_OPTIONS.map((opt) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      className={`flex-1 gap-y-3 rounded-xl p-4 ${active ? 'bg-primary-800 dark:bg-primary-200' : 'bg-primary-200 dark:bg-primary-800'}`}>
                      <SortIcon
                        size={18}
                        color={active ? theme.primary[200] : theme.primary[500]}
                      />
                      <Text
                        className={`font-SpaceGrotesk-Medium text-sm ${active ? 'text-primary-200 dark:text-primary-800' : 'text-primary-600 dark:text-primary-400'}`}>
                        {opt.label}
                      </Text>
                    </TouchableOpacity>
                  );
                ...
                {(['ascending', 'descending'] as SortOrder[]).map((o) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      className={`flex-1 gap-y-1 rounded-xl px-4 py-4 ${active ? 'bg-primary-800 dark:bg-primary-200' : 'bg-primary-200 dark:bg-primary-800'}`}>
