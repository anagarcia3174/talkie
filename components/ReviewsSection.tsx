...
import { TMDBReview } from '~/types/tmdbTypes';
      ...
      <Carousel
        ...
        renderItem={({ item }) => (
          <TouchableOpacity activeOpacity={0.9} className="mx-2 ">
            <BlurView
              intensity={25}
              className="h-full overflow-hidden rounded-2xl border border-primary-300 dark:border-primary-700">
              <View className="flex-1 flex-row bg-primary-100/70 dark:bg-primary-800/70">
