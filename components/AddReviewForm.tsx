    ...
    <View
      ...
      <BlurView
        ...
        <View className="px-4 py-4">
              ...
              <TouchableOpacity
                ...
                <View className="relative items-center justify-center">
                  <Star
                    strokeWidth={1.2}
                    size={30}
                    color={star <= rating ? (theme.isDark ? 'gold' : 'gold') : theme.primary[500]}
                    fill={star <= rating ? (theme.isDark ? 'gold' : 'gold') : 'transparent'}
                  />
          ...
          <View className="mb-2 h-[1px] bg-primary-400/50 dark:bg-primary-800"></View>
          {/* Input Row */}
